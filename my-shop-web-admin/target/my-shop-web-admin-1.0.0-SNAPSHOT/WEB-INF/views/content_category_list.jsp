                                ...
                                <c:forEach items="${tbContentCategories}" var="tbContentCategory">
                                    <tr id="${tbContentCategory.id}" pId="${tbContentCategory.parent.id}">
                                        ...
                                        <td>
                                            ...
                                            <button  type="button" class="btn  btn-danger btn-sm" onclick="App.deleteSingle('/content/category/delete','${tbContentCategory.id}','警告：该删除操作会将包括选中类目在内的全部子类目及所属类目的内容一并删除，请谨慎操作！您还确定继续吗?')"><i class="fa fa-trash-o"></i>删除</button>
                                            <a href="/content/category/form?parent.id=${tbContentCategory.id}&parent.name=${tbContentCategory.name}" type="button" class="btn  btn-default btn-sm"><i class="fa fa-plus"></i>新增下级菜单</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
