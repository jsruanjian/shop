                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-body">
                                ...
                                <button onclick="App.deleteMulti('/content/delete');" type="button" class="btn  btn-default btn-sm"><i class="fa fa-trash-o"></i> 删除</button>&nbsp;&nbsp;&nbsp;
                                ...
                                <button  type="button" class="btn  btn-primary btn-sm" onclick="$('.box-info-search').css('display')=='none'?$('.box-info-search').show('faster'):$('.box-info-search').hide('faster')"><i class="fa fa-search"></i> 搜索</button>
                            </div>
